...
namespace ClusterCoordinator.Actors;

public class ClusterController : ReceiveActor
{
    ...
    public ClusterController(IRequiredActor<ShardListener> shardListener, IRequiredActor<IngressListener> ingressListener)
    {
